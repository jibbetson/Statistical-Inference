...
CLT says the distribution of the mean of n samples will approximate a normal distribution about the population mean for large n. But a normal distribution has long tails, so there is always the chance that a sample mean will be quite far from the population mean. Moreover, the probability will depend on n.

This begs the questions: for finite n, what is the actual probability that the sample mean is within a specfic distance (in quantile units) of the population mean.

This lecture was really confusing. My notes are incomplete - see the book for details.  
